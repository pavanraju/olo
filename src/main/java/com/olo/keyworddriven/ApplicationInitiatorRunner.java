...
public class ApplicationInitiatorRunner extends ApplicationInitiator implements ITest{
	
	private String testFilePath;
	private String testName;
	private Class<? extends Keywords> keywords;
	
	public ApplicationInitiatorRunner(String testFilePath, Class<? extends Keywords> keywords){
